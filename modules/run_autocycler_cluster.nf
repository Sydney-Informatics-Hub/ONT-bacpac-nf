process autocycler_cluster {
  ...
  output:
  tuple val(sample), path("autocycler_cluster_out"), emit: cluster_out
  tuple val(sample), path("autocycler_cluster_out/clustering/qc_pass/cluster_*"), emit: pass_clusters
